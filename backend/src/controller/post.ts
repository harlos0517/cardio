...
export const getPost = controller<PostApi.GetPost.Response>(async(req, res, _next) => {
  const { id } = req.params
...
export const getLatestPosts = controller<PostApi.GetLatestPosts.Response>(async(req, res, _next) => {
...
export const getMyPosts = controller<PostApi.GetLatestPosts.Response>(async(req, res, _next) => {
...
export const createPost = controller<PostApi.CreatePost.Response, PostApi.CreatePost.Request>(async(req, res, _next) => {
